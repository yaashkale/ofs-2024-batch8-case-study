...
class RootViewModel {
  ...
  constructor() {
    ...
    const navData = [
      ...
      { path: "registeration", detail: { label: "Registration", iconClass: "oj-ux-ico-user-plus" } },
      { path: "login", detail: { label: "Login", iconClass: "oj-ux-ico-user-plus" } } // Ensure "Login" path is correct
    ];
    ...
    this.appName = ko.observable("BankApp");
        ...
        // Retrieve and set the username from sessionStorage
        const storedUsername = sessionStorage.getItem('username');
        console.log(storedUsername);
        if (storedUsername) {
            this.userLogin(storedUsername);
        }
